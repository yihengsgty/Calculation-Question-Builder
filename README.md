...
事件起始原因：我15岁，我弟弟比我小七岁，有一天他因为平板没有带回家，所以在家里发脾气，我妈妈让我拿一些计算题给他做，但是我懒得一道题一道题编，于是我写了一个C++程序来生成。最开始默认生成100题0～100以内的，后来事情解决了，我于是把这个代码搁置了。然后最近突发奇想，把代码做了亿点点优化。我最开始的代码：
...
>**⚠️ GrapheneOS 用户特别说明**
>
>由于 GrapheneOS 对文件访问权限的严格控制，本程序可能无法直接写入 Documents 文件夹。
>
>解决方法：
>如果你了解 C++，（或者你可以找到其他人代工）可以提取源码，将代码中的 fout 替换为
>cout，然后直接在终端输出题目，长按终端界面选择“全选”进行复制。
>如果不放心，可以在这里提交issue，我亲自操刀处理。
>
>如果你不想折腾代码，只需在系统设置里手动给本应用开启“所有文件访问权限”即可恢复正常文件输出。
